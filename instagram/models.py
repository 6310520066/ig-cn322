...
class NotificationComment(models.Model):
    recipient = models.ForeignKey(User, on_delete=models.CASCADE, related_name='noticomment')
    sender = models.ForeignKey(User, on_delete=models.CASCADE)
    post = models.ForeignKey(Image, blank=True, null=True, on_delete=models.CASCADE)
...
class NotificationFollow(models.Model):
    recipient = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notifollow')
    sender = models.ForeignKey(User, on_delete=models.CASCADE)
